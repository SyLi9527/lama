...
from bin.predict_b64 import predict as predict_b64
...
def predict(payload: Payload):
    ...
    config = OmegaConf.load('default.yaml')
    b64_predit = predict_b64(predict_config=config, b64_image=image_decoded_string, b64_mask=mask_decoded_string,  img_ext='.png')
    return b64_predit